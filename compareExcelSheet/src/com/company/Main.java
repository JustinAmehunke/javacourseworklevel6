...
/**
 * Created by vaishalipc on 11/5/2018.
 */
public class Main {
    public static void main(String[] srgs) throws IOException {
        ...
        FileInputStream fileInputStream1 = new FileInputStream("Data/spreadsheet1.xls");
        ...
        FileInputStream fileInputStream2 = new FileInputStream("Data/spreadsheet2.xls");
...
//------------------------------ End Name Comparison---------------------------------
                ...
                if(!branchstr1.equals(branchstr2))
                {
                    ...
                    test.log(LogStatus.ERROR,"Diference for id (book1) " + idstr1 + "| Book 1 branch = " + branchstr1+ "| Book 2 branch = " + branchstr2);
                }
...
// ------------------------------ comapring marks --------------------------
                ...
                if(!marksstr1.equals(marksstr2))
                {
                    ...
                    test.log(LogStatus.ERROR,"Diference for id (book1) " + idstr1 + " | Book 1 marks = " + marksstr1+ " | Book 2 marks = " + marksstr2);
                }
...
// ------------------------------ comapring city --------------------------
                ...
                if(!citystr1.equals(citystr2))
                {
                    ...
                    test.log(LogStatus.ERROR,"Diference for id (book1) " + idstr1 + " | Book 1 city = " + citystr1+ " | Book 2 city = " + citystr2);
                }
//------------------------------ End city Comparison---------------------------------
